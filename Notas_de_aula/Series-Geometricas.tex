...
As Séries Geométricas tipicamente são aplicadas a problemas de juros
compostos. Para sairmos do óbvio, vamos ver uma aplicação diferente
desta ferramenta. Vocês poderão aplicar estas técnicas em problemas de
juros compostos nos exercícios e problemas do livro.
